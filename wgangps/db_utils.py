...
from tensorflow.keras.layers import Dense, Conv1D, Conv2D, Conv2DTranspose, Flatten, Dropout, ReLU, ELU, Input, MaxPooling1D, Reshape, BatchNormalization, Activation, Lambda
